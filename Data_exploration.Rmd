...
elev_res2mask = resample(x = project(elev, crs(mask)), y = mask, method = 'average')
...
```
```{r}
soilH = rast('prepared/Predictors/SPEEDMIND_SoilH.tif') #CRS 3395
...
### LC Areal
```{r}
AS_LC <- rast('prepared/Arealstatistik/AS18_72.tif')
...
```{r}
st_r('prepared/Corine_Landcover/CLC_CH_2018.shp')
```
